...
HTTPS_GIT := github.com/rollchains/minechain.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=minechain \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c minechain --local -f chains.yaml
endif
